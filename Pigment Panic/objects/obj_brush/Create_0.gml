...
default_clickables = [obj_but_start, obj_but_creds, obj_but_help, obj_but_quit, obj_but_pause, obj_color_slot, obj_tap, obj_lv_one_one, obj_lv_one_two, obj_lv_one_three,
